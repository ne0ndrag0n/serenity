...
Result ConnectionToServer::try_request_user_deletion(uid_t user_id, GUI::Window* parent_window)
{
    ...
    async_request_user_deletion(id, static_cast<i32>(user_id), static_cast<i32>(getuid()), parent_window_server_client_id, parent_window_id);
...
Result ConnectionToServer::try_request_user_addition(GUI::Window* parent_window)
{
    ...
    async_request_user_addition(id, static_cast<i32>(getuid()), parent_window_server_client_id, parent_window_id);
