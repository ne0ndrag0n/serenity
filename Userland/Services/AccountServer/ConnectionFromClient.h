...
private:
    ...
    void fail(String error_message, i32 promise_id, GUI::Window* main_window);

    ErrorOr<ExpandedUserPair> expand_user_pair(i32 target_user_id, i32 active_user_id);
    ErrorOr<EscalatorWindow::AuthorizationResult> authorize(GUI::Window* parent_window, ExpandedUserPair const& users);
